...
1. **[Mamba](https://huggingface.co/docs/main/transformers/model_doc/mamba)** (from <FILL INSTITUTION>) released with the paper [<FILL PAPER TITLE>](<FILL ARKIV LINK>) by <FILL AUTHORS>.
