    ...
    if not SKIP_CUDA_BUILD:
        ...
        module = load(
            ...
            sources=[
                ...
                root_dir / "kernels/mamba/selective_scan_fwd_fp32.cu",
                root_dir / "kernels/mamba/selective_scan_fwd_fp16.cu",
                root_dir / "kernels/mamba/selective_scan_fwd_bf16.cu",
                root_dir / "kernels/mamba/selective_scan_bwd_fp32_real.cu",
                root_dir / "kernels/mamba/selective_scan_bwd_fp32_complex.cu",
                root_dir / "kernels/mamba/selective_scan_bwd_fp16_real.cu",
                root_dir / "kernels/mamba/selective_scan_bwd_fp16_complex.cu",
                root_dir / "kernels/mamba/selective_scan_bwd_bf16_real.cu",
                root_dir / "kernels/mamba/selective_scan_bwd_bf16_complex.cu",
            ],
            with_cuda=True,
            ...
            extra_include_paths=[str(root_dir / "kernels" / "mamba")],
